...
namespace TicketBookingSystemApp.Infrastructure.Migrations
{
    ...
    [Migration("20250329185218_Application_UserId_Added")]
    partial class Application_UserId_Added
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TicketBookingSystemApp.Domain.Booking", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            BookingId = 1,
                            BookingDate = new DateTime(2025, 3, 30, 0, 22, 17, 491, DateTimeKind.Local).AddTicks(9142),
                            EventId = 1,
                            SeatNumber = 1,
                            Status = "Pending",
                            UserId = 1
