...
namespace TicketBookingSystemApp.Infrastructure.Migrations
{
    ...
    [Migration("20250328163830_User and Booking Data seeding")]
    partial class UserandBookingDataseeding
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TicketBookingSystemApp.Domain.Booking", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            BookingId = 1,
                            BookingDate = new DateTime(2025, 3, 28, 22, 8, 29, 823, DateTimeKind.Local).AddTicks(6091),
                            EventId = 1,
                            SeatNumber = 1,
                            Status = "Pending",
                            UserId = 1
