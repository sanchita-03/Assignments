...
namespace TicketBookingSystemApp.Infrastructure.Migrations
{
    ...
    [Migration("20250331081522_BookingSeats delete")]
    partial class BookingSeatsdelete
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TicketBookingSystemApp.Domain.Booking", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            BookingId = 1,
                            BookingDate = new DateTime(2025, 3, 31, 13, 45, 21, 751, DateTimeKind.Local).AddTicks(5111),
                            EventId = 1,
                            SeatNumber = 1,
                            Status = "Pending",
                            UserId = 1
